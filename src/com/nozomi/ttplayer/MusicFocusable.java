 ...
 * instead of just using AudioManager.OnAudioFocusChangeListener because that
 * interface is only available in SDK level 8 and above, and we want our
 * application to work on previous SDKs.
 */
